...
public interface BinaryTree {
    ...
    BinaryTreeNode buildTreeByPreAndInOrder(List<Character> preOrder, List<Character> inOrder);

    BinaryTreeNode buildTreeByInAndPostOrder(List<Character> inOrder, List<Character> postOrder);
}
